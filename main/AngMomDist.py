...
from main.Grain import acx, Inertia_largest, grainparams
from core.infrared import FGIR_averaged
from core.collisions import Tev_effective, FGn_averaged, FGi_averaged
